    ...
    if not no_log_pms_sql.is_approved(message.chat.id) and message.chat.id != 777000:
        ...
        try:
            if message.from_user.id != client.me.id:
                await message.forward(BOTLOG_CHATID)
            LOG_CHATS_.COUNT += 1
        except BaseException:
            pass


@bot.on_message(filters.group & filters.mentioned & filters.incoming)
...
@bot.on_message(filters.command("log", cmd) & filters.me)
...
@bot.on_message(filters.command("nolog", cmd) & filters.me)
...
@bot.on_message(filters.command(["pmlog", "pmlogger"], cmd) & filters.me)
...
@bot.on_message(filters.command(["gruplog", "grouplog", "gclog"], cmd) & filters.me)
