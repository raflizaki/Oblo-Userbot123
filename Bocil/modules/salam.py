...
@bot.on_message(filters.command("p", cmd) & filters.me)
...
@bot.on_message(filters.command("pe", cmd) & filters.me)
...
@bot.on_message(filters.command("l", cmd) & filters.me)
...
@bot.on_message(filters.command("el", cmd) & filters.me)
...
@bot.on_message(filters.command("a", cmd) & filters.me)
...
@bot.on_message(filters.command("ass", cmd) & filters.me)
...
@bot.on_message(filters.command("j", cmd) & filters.me)
...
@bot.on_message(filters.command("k", cmd) & filters.me)
