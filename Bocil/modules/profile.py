...
flood = {}
profile_photo = "Bocil/modules/cache/pfp.jpg"


@bot.on_message(filters.command(["block"], cmd) & filters.me)
...
@bot.on_message(filters.command(["unblock"], cmd) & filters.me)
...
@bot.on_message(filters.command(["setname"], cmd) & filters.me)
...
@bot.on_message(filters.command(["setbio"], cmd) & filters.me)
...
@bot.on_message(filters.me & filters.command(["setpfp"], cmd))
...
@bot.on_message(filters.me & filters.command(["vpfp"], cmd))
