...
@bot.on_message(filters.me & filters.command("invite", cmd))
...
@bot.on_message(filters.command(["inviteall"], cmd) & filters.me)
...
@bot.on_message(filters.command("invitelink", cmd) & filters.me)
