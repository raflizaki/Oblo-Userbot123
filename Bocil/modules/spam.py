...
from Bocil.config import BLACKLIST_CHAT, BOTLOG_CHATID
from Bocil.config import HANDLER as cmd
from Bocil.helpers.basic import edit_or_reply
from Bocil.utils.misc import extract_args
...
@bot.on_message(filters.me & filters.command(["dspam", "delayspam"], cmd))
...
@bot.on_message(filters.command(commands, cmd) & filters.me)
