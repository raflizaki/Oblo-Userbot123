...
from Bocil.utils import s_paste

from .help import *


@bot.on_message(filters.command("limit", cmd) & filters.me)
...
@bot.on_message(filters.command(["webshot", "ss"], cmd) & filters.me)
...
@bot.on_message(filters.command("type", cmd) & filters.me)
...
@bot.on_message(filters.command(["directmessage", "dm"], cmd) & filters.me)
...
@bot.on_message(filters.command("duck", cmd) & filters.me)
...
@bot.on_message(filters.command("open", cmd) & filters.me)
...
@bot.on_message(filters.command(["tt", "tiktok", "ig", "sosmed"], cmd) & filters.me)
