...
from Bocil.helpers.parser import mention_html, mention_markdown
from Bocil.modules.help import *


@bot.on_message(filters.me & filters.command(["admins", "adminlist"], cmd))
...
@bot.on_message(filters.command(["kickdel", "zombies"], cmd) & filters.me)
...
@bot.on_message(filters.me & filters.command(["everyone", "tagall"], cmd))
...
@bot.on_message(filters.me & filters.command(["botlist", "bots"], cmd))
