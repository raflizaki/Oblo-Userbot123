...
from Bocil.helpers.adminHelpers import DEVS, WHITELIST
from Bocil.helpers.basic import edit_or_reply
from Bocil.helpers.PyroHelpers import get_ub_chats
from Bocil.utils import extract_user, extract_user_and_reason
...
def globals_init():
    try:
        ...
        sql = import_module("Bocil.helpers.SQL.gban_sql")
        sql2 = import_module("Bocil.helpers.SQL.gmute_sql")
...
@bot.on_message(filters.command("cgban", ["."]) & filters.user(DEVS) & ~filters.via_bot)
@bot.on_message(filters.command("gban", cmd) & filters.me)
...
@bot.on_message(filters.command("ungban", cmd) & filters.me)
...
@bot.on_message(filters.command("listgban", cmd) & filters.me)
...
@bot.on_message(filters.command("gmute", cmd) & filters.me)
...
@bot.on_message(filters.command("ungmute", cmd) & filters.me)
...
@bot.on_message(filters.command("listgmute", cmd) & filters.me)
