...
from Bocil.helpers.tools import get_arg, get_text, resize_media
from Bocil.utils.tools import add_text_img, bash

from .help import add_command_help


@bot.on_message(filters.command(["tikel", "kang"], cmd) & filters.me)
async def kang(client: Client, message: Message):
    ...
    if replied and replied.media:
        if replied.photo:
            ...
            return
        media_ = await client.download_media(replied, file_name="Bocil/resources/")
    else:
...
@bot.on_message(filters.command(["packinfo", "stickerinfo"], cmd) & filters.me)
...
@bot.on_message(filters.command("stickers", cmd) & filters.me)
...
@bot.on_message(filters.command("tiny", cmd) & filters.me)
async def tinying(client: Client, message: Message):
    ...
    im1 = Image.open("Bocil/resources/blank.png")
    if ik.endswith(".tgs"):
...
@bot.on_message(filters.command(["mmf", "memify"], cmd) & filters.me)
...
@bot.on_message(filters.command(["get", "getsticker", "mtoi"], cmd) & filters.me)
