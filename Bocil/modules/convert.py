...
from Bocil.helpers.tools import run_cmd


@bot.on_message(filters.command("extractaudio", cmd) & filters.me)
...
@bot.on_message(filters.command("makevoice", cmd) & filters.me)
