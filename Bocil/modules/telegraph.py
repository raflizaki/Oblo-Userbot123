...
from Bocil.helpers.basic import edit_or_reply, get_text
from Bocil.helpers.tools import *

from .help import *

telegraph = Telegraph()
r = telegraph.create_account(short_name="Bocil-Userbot")
auth_url = r["auth_url"]


@bot.on_message(filters.command(["tg", "telegraph"], cmd) & filters.me)
