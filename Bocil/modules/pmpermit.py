...
from Bocil import TEMP_SETTINGS, bot
...
from Bocil.helpers.SQL.globals import addgvar, gvarstatus
...
async def incomingpm(client: Client, message: Message):
    try:
        from Bocil.helpers.SQL.globals import gvarstatus
        from Bocil.helpers.SQL.pm_permit_sql import is_approved
...
async def auto_accept(client, message):
    try:
        from Bocil.helpers.SQL.pm_permit_sql import approve, is_approved
    except BaseException:
        pass
...
async def approvepm(client: Client, message: Message):
    try:
        from Bocil.helpers.SQL.pm_permit_sql import approve
    except BaseException:
...
async def disapprovepm(client: Client, message: Message):
    try:
        from Bocil.helpers.SQL.pm_permit_sql import dissprove
    except BaseException:
        await message.edit("Running on Non-SQL mode!")
        return
...
@bot.on_message(filters.command("pmlimit", cmd) & filters.me)
async def setpm_limit(client: Client, cust_msg: Message):
    ...
    try:
        from Bocil.helpers.SQL.globals import addgvar
...
@bot.on_message(filters.command(["pmpermit", "pmguard"], cmd) & filters.me)
...
@bot.on_message(filters.command("setpmpermit", cmd) & filters.me)
async def setpmpermit(client: Client, cust_msg: Message):
    ...
    try:
        import Bocil.helpers.SQL.globals as sql
    except AttributeError:
        await cust_msg.edit("**Running on Non-SQL mode!**")
        return
    Man = await cust_msg.edit("`Processing...`")
...
@bot.on_message(filters.command("getpmpermit", cmd) & filters.me)
...
@bot.on_message(filters.command("resetpmpermit", cmd) & filters.me)
