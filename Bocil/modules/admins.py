...
from Bocil.utils.misc import extract_user, extract_user_and_reason, list_admins
...
@bot.on_message(filters.group & filters.command("ban", cmd) & filters.me)
...
@bot.on_message(filters.command("cunban", ["."]) & filters.user(DEVS) & ~filters.me)
@bot.on_message(filters.group & filters.command("unban", cmd) & filters.me)
...
@bot.on_message(filters.command(["pin", "unpin"], cmd) & filters.me)
...
@bot.on_message(filters.command(["cmute"], ["."]) & filters.user(DEVS) & ~filters.me)
@bot.on_message(filters.command("mute", cmd) & filters.me)
...
@bot.on_message(filters.command(["cunmute"], ["."]) & filters.user(DEVS) & ~filters.me)
@bot.on_message(filters.group & filters.command("unmute", cmd) & filters.me)
...
@bot.on_message(filters.command(["kick", "dkick"], cmd) & filters.me)
...
@bot.on_message(filters.group & filters.command("demote", cmd) & filters.me)
