...
from Bocil.helpers.msg_types import Types, get_message_type
from Bocil.helpers.parser import escape_markdown, mention_markdown
from Bocil.helpers.SQL.afk_db import get_afk, set_afk
...
@bot.on_message(filters.me & filters.command("afk", cmd))
...
@bot.on_message(filters.me & filters.group, group=12)
