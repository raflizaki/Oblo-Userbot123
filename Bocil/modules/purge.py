...
@bot.on_message(filters.command("cdel", ["."]) & filters.user(DEVS) & ~filters.via_bot)
@bot.on_message(filters.command("del", cmd) & filters.me)
...
@bot.on_message(filters.command("purge", cmd) & filters.me)
...
@bot.on_message(filters.command("purgeme", cmd) & filters.me)
