...
from Bocil.helpers.misc import HAPP, in_heroku
...
@bot.on_message(filters.command("setvar", HANDLER) & filters.me)
...
@bot.on_message(filters.command("getvar", HANDLER) & filters.me)
...
@bot.on_message(filters.command("delvar", HANDLER) & filters.me)
...
@bot.on_message(filters.command("usage", HANDLER) & filters.me)
...
@bot.on_message(filters.command("usange", HANDLER) & filters.me)
