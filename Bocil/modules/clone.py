...
from Bocil.helpers.basic import edit_or_reply, get_text, get_user
...
@bot.on_message(filters.command("clone", cmd) & filters.me)
...
@bot.on_message(filters.command("revert", cmd) & filters.me)
