...
ADMIN1_ID = int (getenv("ADMIN1_ID") or 0)
ADMIN2_ID = int (getenv("ADMIN2_ID") or 0)
ADMIN3_ID = int (getenv("ADMIN3_ID") or 0)
ADMIN4_ID = int (getenv("ADMIN4_ID") or 0)
ADMIN5_ID = int (getenv("ADMIN5_ID") or 0)
ADMIN6_ID = int (getenv("ADMIN6_ID") or 0)
ADMIN7_ID = int (getenv("ADMIN7_ID") or 0)
